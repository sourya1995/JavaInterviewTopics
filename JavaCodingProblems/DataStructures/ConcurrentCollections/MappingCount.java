...
public class MappingCount {
    ...
    private MappingCount() {
        throw new AssertionError("MappingCount cannot be instantiated");
    }
    ...
    private static final ExecutorService producerService = Executors.newFixedThreadPool(10);
    ...
    private static class Consumer implements Runnable {
        ...
        public void run() {
           while(true) {
                LOGGER.info(() -> "Mapping count:" + map.mappingCount() + "Count via atomic variable:" + count.get() + "Size: " + map.size());
           }
        }
