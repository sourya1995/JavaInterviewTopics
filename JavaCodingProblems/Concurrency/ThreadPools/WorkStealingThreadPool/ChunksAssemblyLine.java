...
public class ChunksAssemblyLine {
    private ChunksAssemblyLine() {
        throw new AssertionError("There is a single instance");
    }

    private static final Logger LOGGER = Logger.getLogger(ChunksAssemblyLine.class.getName());
    ...
    private static class Consumer implements Runnable {
        ...
        public void run() {
            while (!bulbs.isEmpty()) {
                ...
                if (bulb != null) {
                    LOGGER.info(() -> "Packed bulb" + bulb + "by consumer" + Thread.currentThread().getName());
                }
