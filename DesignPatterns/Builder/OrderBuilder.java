...
public class OrderBuilder {
    ...
    public OrderedItems preparePizza() {
        OrderedItems itemOrder = new OrderedItems();
        ...
        switch (pizzaaandcolddrinkchoice) {
            case 1:
                System.out.println(
                "We ordered Veg 
            Pizza
...
ordered Onion Pizza
                                "); 
 System.out.println("Enter Onion pizza size");
                                System.out.println("----------------------");
                                ...
                                switch (onionpizzasize) {
                                    case 1:
                                        itemsOrder
                                                .addItems(new SmallOnionPizza());
                                        break;

                                    case 2:
                                        itemsOrder.
                                                addItems(new MediumOnionPizza());
                                        break;

                                    case 3:
                                        itemsOrder.
                                                addItems(new LargeOnionPizza());
                                        break;

                                    case 4:
                                        itemsOrder
                                                .addItems(new ExtraLargeOnionPizza());
                                        break;
                            ...
                            break;
                            case 3: {
                                System.out.println("We ordered Masala Pizza");
                                System.out.println("Enter Masala pizza size");
                                System.out.println("---------------------");
 ...
 int masalapizzasize
                    ...
                    break;// Veg-pizza choice complete 

                    case 2: {
                        System.out.println("We ordered 
Non - Veg Pizza     
                ...
                //continued? 
                System.out.println("Enter choice of ColdDrink");
                System.out.println("======================");
                ...
                switch (coldDrink) {
                    case 1: {
                        System.out.println("We ordered Pepsi");
                        System.out.println("Enter PepsiSize");
                        System.out.println("----------------");
                    ...
                    case 2: {
                        System.out.println("We ordered Coke");
